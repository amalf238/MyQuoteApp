...
class PhilosophersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create philosopher" do
    assert_difference("Philosopher.count") do
      post philosophers_url, params: { philosopher: { biography: @philosopher.biography, birthYear: @philosopher.birthYear, deathYear: @philosopher.deathYear, fname: @philosopher.fname, lname: @philosopher.lname } }
    end
  ...
  test "should update philosopher" do
    patch philosopher_url(@philosopher), params: { philosopher: { biography: @philosopher.biography, birthYear: @philosopher.birthYear, deathYear: @philosopher.deathYear, fname: @philosopher.fname, lname: @philosopher.lname } }
